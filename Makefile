...
all: packet_gen_client packet_gen_client_fast echo_server echo_server_checksum_exp
...
clean:
	rm -f packet_gen_client packet_gen_client_fast echo_server echo_server_checksum_exp
